...
nohup java -jar -Dspring.config.location=/home/ec2-user/toy-project-board/application-db.yml,classpath:/application-$IDLE_PROFILE.yml -Dspring.profiles.active=$IDLE_PROFILE $JAR_NAME > $JAR_PATH/nohup.out 2>&1 &
